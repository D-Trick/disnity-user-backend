...
export class CreateDto {
    @MaxLength(22, { message: SERVER_MESSAGES.SERVER_NOT_FOUND })
    @IsNumberString({ no_symbols: true }, { message: SERVER_MESSAGES.SERVER_NOT_FOUND })
    id: string;
    ...
    @IsIn(['basic', 'markdown'], { message: SERVER_MESSAGES.BAD_INVITE_AUTO })
